...
fetch(`https://gateway.marvel.com/v1/public/comics?format=comic&formatType=comic&noVariants=false&dateDescriptor=lastWeek&orderBy=title&&ts=${timeStamp}&apikey=${publicKey}&hash=${MD5hash}` //Consumo da API - Marvel
).then((response) => {
